...
description: |
  Genera un prep doc ejecutivo completo para una entrevista laboral específica, con investigación profunda sobre empresa y entrevistador, calibrado al perfil del usuario, y con modo sparring (entrevistador hostil simulado calibrado a los weak spots reales del usuario) sobre los puntos débiles del fit. La skill opera en dos modos: (a) onboarding conversacional de 45-60 minutos que construye el perfil del usuario la primera vez, y (b) prep para una entrevista concreta cuando el perfil ya existe. Usar SIEMPRE que el usuario mencione preparar, planificar o investigar para una entrevista laboral. Triggers principales: "prepárame entrevista" / "preparame entrevista", "tengo entrevista con", "me entrevistan en", "prep para [empresa/persona]", "ayúdame con la entrevista" / "ayudame con la entrevista", "armame el doc para la entrevista". También cuando comparta link de oferta laboral + LinkedIn de entrevistador, o cuando pegue una JD mencionando un proceso concreto. También cuando el usuario diga "armemos mi perfil", "hagamos el onboarding", "actualicemos mi contexto". NO usar para coaching general de carrera, revisión de CV, brainstorming estratégico de búsqueda, o discusión de oportunidades sin entrevista agendada.
---
